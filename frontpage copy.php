...
<section class="cta_thumbs">
	<div class="container-fluid">
		<div class="row">
			<div class="wrapper-info">
					<div class="row row-flex equal-image-container">
						...
						<div class="w-25 item">
							<a href="<?php bloginfo('url'); ?>/services/access-control-system"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/stratos-access-control.jpg" alt="" style="object-position:25% 50%"></a>
						</div>
						
						
						<div class="w-25 item">
							<a href="<?php bloginfo('url'); ?>/services/video-surveilance-analytics"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/stratos-video-th.jpg" alt="" style="object-position:25% 50%"></a>
						</div>
					</div>
