<?php get_header(); /*Template Name: Video Surveilance Analytics */ ?>


<section class="cstm_hero vsa_hero">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
...
<section class="cstm_serv vsa_serv">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
...
<section class="cstm_half vsa_half" >
...
<section class="cstm_enquire vsa_enquire mb-3">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="wrapper">
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="wrapper">
				...
				<div class=" item">
					<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/stratos-video-th.jpg" alt=""></a>
				</div>
