<?php get_header(); /*Template Name: Burglar And Alarm System */ ?>



<section class="cstm_hero buglar_hero">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
...
<section class="cstm_serv burglar_serv">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
...
<section class="cstm_half buglar_half" >
...
<section class="cstm_enquire burglar_enquire mb-10">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="wrapper">
...
<!-- <section class="cta_thumbs other_serv">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="wrapper">
				<div class=" item">
					<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/stratos-burglar-th.jpg" alt=""></a>
				</div>
