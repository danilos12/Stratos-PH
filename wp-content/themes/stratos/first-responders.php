<?php get_header(); /*Template Name: First Responders */ ?>


<section class="cstm_hero fresponse_hero">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
		...
		<div class="row">
			<div class="wrapper">
				<h1>Services</h1>
				<div class="separator">
					<img src="assets/img/stratos-seperator.png" alt="">
				</div>
			</div>
		</div>
...
<section class="cstm_serv fresponse_serv">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
...
<section class="cstm_half fresponse_half" >
...
<section class="cstm_enquire frespnse_enquire mb-3">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="wrapper">
