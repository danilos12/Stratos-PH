  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
	    <ul class="nav navbar-nav  navbar-right">
	      ...
	      <li <?php echo (is_page('support') ? 'class="active"' : ''); ?>><a href="<?php bloginfo('url'); ?>/support">IT Support</a></li>
	      <li class="search"><a data-toggle="modal" data-target="#myModal"><i class="fa fa-search"></i></a></li>
	      <li id="navbar-user-status" style="display:none;">
	        <a href="javascript:void(0);" style="display:flex; align-items:center; gap:8px; padding:15px 10px;">
	          <img id="navbar-user-avatar" src="" alt="" style="width:28px; height:28px; border-radius:50%;">
	          <span id="navbar-user-name" style="font-size:13px; font-weight:600; color:#fff;"></span>
	          <button type="button" id="navbar-logout-btn" style="background:#CC1A42; color:#fff; border:none; border-radius:4px; padding:4px 12px; font-size:11px; cursor:pointer; font-weight:600; margin-left:4px;">Logout</button>
	        </a>
	      </li>
	    </ul>
	</div>
