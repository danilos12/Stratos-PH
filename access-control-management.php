<?php get_header(); /*Template Name: Access Control Management */ ?>



<section class="cstm_hero accm_hero">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
...
<section class="cstm_serv accm_serv">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
...
<section class="cstm_half accm_half" >
...
<section class="cstm_enquire accm_enquire mb-10">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="wrapper">

					<img class="ftrd" src="<?php the_field('keyvisual_e'); ?>" alt="">
					<p class="en"><?php the_field('headline_e'); ?></p>
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="wrapper">
				...
				<div class=" item">
					<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/stratos-access-control.jpg" alt=""></a>
				</div>
